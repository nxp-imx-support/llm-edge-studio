# Adding Models to LLM Edge Studio
...
## Case 1: LLM Edge Studio NOT installed yet
...
```bash
scp llm-edge-studio.deb user@<your boards IP>:/user/
```

### Step 2. Install the LLM Edge Studio application
```bash
...
## Case 2: LLM Edge Studio already installed
